              ...
              <Row>
                ...
                <Col s={12} className="">
                    <CardPanel className="grey lighten-2 black-text">
                      <input type="text" pattern="[0-9.]+(\.[0-9][0-9]?)?" value={this.state.amount} required readOnly/>    
                    </CardPanel>
                  ...
                  <div className="buttons">
                    <Col s={4}><Button node="button" large waves="light" className="blue ibtn" onClick={this.props.toggleCurrency.bind(this)}>{this.state.currency}</Button></Col>
